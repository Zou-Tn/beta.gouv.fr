---
fullname: Zoubeir BELAID # penser à modifier le nom du fichier ci-dessus en prenom.nom.md !
role: Project Manager # Développeuse / Développeur / Intrapreneuse / Intrapreneur / Coach / Chargée de développement / Chargé de développement...
github: Zou-Tn # optionnel : nom d'utilisateur GitHub, permet d'être ajouté automatiquement à l'organisation GitHub betagouv
avatar: Zou # optionnel, voir ci-dessous
...
# Enfin, si aucune image n'est trouvée, alors la fiole beta.gouv.fr sera utilisée sur la page communautaire
lien: # optionnel: lien vers une page perso externe.
